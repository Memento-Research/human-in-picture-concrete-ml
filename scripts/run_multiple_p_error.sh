...
image_sizes=( "96"   "96"  "96"   "96"  "96"   "96"   "96"   "96" "96"   "96"  )
n_bits=(      "6"    "6"   "6"    "6"   "6"    "6"    "6"    "6"  "6"    "6"   )
p_errors=(    "0.05" "0.1" "0.15" "0.2" "0.25" "0.3" "0.35" "0.4" "0.45" "0.5" )
...
for ((i=0; i<${#image_sizes[@]}; i++)); do
    for ((j=0; j<10; j++)); do
        ...
        poetry run python3 src/ConvolutionalNeuralNetwork.py "${image_sizes[i]}" "${n_bits[i]}" "${p_errors[i]}" "use_fhe" "${j}" "/p_error"
        exit_code=$?
